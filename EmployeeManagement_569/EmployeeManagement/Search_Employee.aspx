                ...
                <div class="row  table-responsive">
                    <div style="width: 95%; margin-left: 2%; margin-right: 20%;">
                        <asp:GridView ID="grd" CssClass="table table-bordered table-hover dataTable" runat="server" HeaderStyle-BackColor="#ede8e8" AutoGenerateColumns="true" OnRowDataBound="grd_RowDataBound" OnRowCommand="grd_RowCommand" OnRowEditing="grd_RowEditing" OnRowCreated="grd_RowCreated" >
                            <Columns>
                                <asp:TemplateField HeaderText="COMP_ID" Visible="false">
                                    <ItemTemplate>
                                        <asp:Label ID="llbComp_Id" runat="server" Visible="false" Text='<%# Eval("comp_id") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>

                            <%--   <asp:TemplateField HeaderText="CancelCompaint">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btndelete" runat="server" CommandArgument='<%# Eval("comp_id")  %>' CommandName="del" Text="CancelCompaint" OnClientClick="return confirm('Are you sure you want to delete this Complaint?');"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>--%>

                                <asp:TemplateField HeaderText="Edit">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="btnedit" runat="server" CommandArgument='<%# Eval("comp_id")  %>' CommandName="Edit" Text="Edit" ></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        ...
                                        <asp:LinkButton ID="LinkButton1" runat="server" CommandArgument='<%# Eval("comp_id")+":"+Eval("comp_id")  %>' CommandName="Delete" Text='<%# Eval("comp_id") %>' OnClientClick="return confirm('Are you sure you want to Cancel  this Complaint?');"></asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
