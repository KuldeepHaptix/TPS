            ...
            try
            {
                if (e.CommandName == "Edit")
                {
                    ...
                    if (Comp_id > 0)
                    {
                        ...
                        Response.Redirect("~/ManageEmployee.aspx?Comp_id=" + Comp_id + "", false);
                    }
                }
                else if (e.CommandName == "Delete")
                {
                    ...
                    if (arg.Length == 2)
                    {
                        ...
                        //if (arg[1].ToString().ToLower().Equals("left"))
                        //{
                        //    int.TryParse(Request.Cookies["LoginCookies"]["UserId"].ToString(), out user_id);
                        ...
                        //    if (res == 1)
                        //    {
                        //        res = objmysqldb.InsertUpdateDeleteData("Update left_employee set IsDelete=1,modify_datetime=" + currenttime.Ticks + ",IsUpdate=1,UserID=" + user_id + " where Emp_Id=" + emp_id + "  ");

                        //        if (res != 1)
                        //        {
                        //            ltrErr.Text = "Please Try Again.";
                        //            Logger.WriteCriticalLog("Search_Employee 386 Update error.");
                        //        }
                        //        else
                        //        {
                        //            ltrErr.Text = "Status Update Successfully";
                        ...
                        //    }
                        //}
                        //else if (arg[1].ToString().ToLower().Equals("working"))
                        //{
                        //    //left employee Popup
                        //    if (emp_id > 0)
                        //    {
                        //        Response.Redirect("~/LeftEmployee.aspx?Emp=" + emp_id + "", false);
                        //    }
                        //}
                    }
                }
